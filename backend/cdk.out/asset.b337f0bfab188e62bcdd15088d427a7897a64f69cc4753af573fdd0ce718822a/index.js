...
exports.handler = core_default().use(http_json_body_parser_default()).use(http_header_normalizer_default()).use((0, import_middleware.injectLambdaContext)(logger, { logEvent: true })).use((0, import_middleware2.captureLambdaHandler)(tracer)).use((0, import_middleware3.logMetrics)(metrics)).handler(async (event, context) => {
  try {
    metrics.addMetric(
